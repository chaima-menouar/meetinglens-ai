...
*{box-sizing:border-box}html,body,[class*=css]{font-family:Geist,system-ui,sans-serif}
...
@keyframes rise{from{opacity:0;transform:translateY(18px)}to{opacity:1;transform:none}}@keyframes drift{to{transform:translate(34px,22px) scale(1.08)}}@keyframes breathe{50%{opacity:.72;transform:scale(1.045)}}@keyframes ring{to{transform:rotate(360deg)}}@keyframes dash{to{stroke-dashoffset:-120}}@keyframes wave{0%,100%{height:5px;opacity:.28}50%{height:30px;opacity:.92}}@keyframes sweep{0%,58%{transform:translateX(-140%)}80%,100%{transform:translateX(140%)}}@keyframes ticker{to{transform:translateX(-50%)}}@keyframes flow{to{background-position:-200% 0}}
...
.brand{display:flex;align-items:center;gap:.8rem;margin:.2rem 0 1.35rem}.logo{width:43px;height:43px;border-radius:15px;display:grid;place-items:center;border:1px solid rgba(227,207,173,.22);background:linear-gradient(145deg,#20252a,#12161a);color:var(--champ2);font-weight:600}.brandname{font-size:1rem;font-weight:600;letter-spacing:-.025em}.brandname span{color:var(--champ2)}.micro{font-size:.62rem;text-transform:uppercase;letter-spacing:.16em;color:#717a80;font-weight:500}.sidebox{border:1px solid var(--line);border-radius:17px;padding:1rem;margin-top:.85rem;background:rgba(255,255,255,.012);transition:.25s}.sidebox:hover{transform:translateY(-2px);border-color:rgba(199,173,130,.15)}.sidebox strong{display:block;margin-top:.35rem;font-size:.82rem;font-weight:550}
.top{display:flex;justify-content:space-between;align-items:center;padding:.35rem 0 .95rem;border-bottom:1px solid var(--line);margin-bottom:1.1rem}.crumb{font-size:.64rem;text-transform:uppercase;letter-spacing:.16em;color:#747d83}.ready{display:inline-flex;align-items:center;gap:.5rem;font-size:.69rem;color:#b8c5bf;border:1px solid rgba(146,169,159,.18);padding:.45rem .7rem;border-radius:999px;background:rgba(146,169,159,.04)}.ready i{width:6px;height:6px;border-radius:50%;background:var(--sage);display:block;box-shadow:0 0 0 5px rgba(146,169,159,.05)}
.hero{display:grid;grid-template-columns:.96fr 1.04fr;min-height:610px;border:1px solid var(--line);border-radius:32px;overflow:hidden;background:linear-gradient(135deg,#14181c,#0f1215);box-shadow:0 42px 120px rgba(0,0,0,.28);position:relative;animation:rise .8s both}.hero:before{content:'';position:absolute;inset:0;background:linear-gradient(120deg,transparent 22%,rgba(255,255,255,.025) 46%,transparent 60%);transform:translateX(-140%);animation:sweep 11s ease-in-out infinite;pointer-events:none;z-index:8}
.copy{padding:4.5rem 3.5rem 3.7rem;display:flex;flex-direction:column;justify-content:center;position:relative;z-index:3}.eyebrow{width:max-content;font-size:.62rem;text-transform:uppercase;letter-spacing:.16em;color:#bba784;border:1px solid rgba(199,173,130,.17);border-radius:999px;padding:.45rem .65rem;background:rgba(199,173,130,.035);margin-bottom:1.35rem}
.hero h1{font-weight:400;font-size:clamp(3rem,5.2vw,5.7rem);line-height:.95;letter-spacing:-.062em;margin:0;max-width:690px}.hero h1 .serif{font-family:'Instrument Serif',serif;font-style:italic;font-weight:400;color:var(--champ2);letter-spacing:-.03em}.hero p{max-width:600px;color:#a7afb4;font-size:1rem;line-height:1.78;margin:1.35rem 0 0}.chips{display:flex;gap:.55rem;flex-wrap:wrap;margin-top:1.4rem}.chip{font-size:.71rem;color:#c2c8cb;border:1px solid var(--line);border-radius:999px;padding:.44rem .65rem;background:rgba(255,255,255,.014)}.promise{display:flex;align-items:center;gap:.75rem;margin-top:1.7rem;font-size:.63rem;letter-spacing:.13em;text-transform:uppercase;color:#747d82}.promise span{height:1px;flex:1;max-width:260px;background:linear-gradient(90deg,var(--champ),var(--sage),transparent);background-size:200% 100%;animation:flow 5s linear infinite}
.canvas{position:relative;min-height:610px;overflow:hidden;background:radial-gradient(circle at 58% 48%,rgba(199,173,130,.09),transparent 20%),radial-gradient(circle at 52% 45%,rgba(146,169,159,.05),transparent 35%),linear-gradient(180deg,#111519,#0e1114)}.canvas:after{content:'';position:absolute;inset:0;background-image:linear-gradient(rgba(255,255,255,.025) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.025) 1px,transparent 1px);background-size:42px 42px;mask-image:linear-gradient(to bottom,rgba(0,0,0,.8),transparent)}
.orbit{position:absolute;left:50%;top:48%;transform:translate(-50%,-50%);width:320px;height:320px;border-radius:50%;border:1px solid rgba(255,255,255,.08);z-index:2}.orbit:before,.orbit:after{content:'';position:absolute;border-radius:50%;inset:25px;border:1px dashed rgba(199,173,130,.24);animation:ring 20s linear infinite}.orbit:after{inset:70px;border-style:solid;border-color:rgba(146,169,159,.14);animation-direction:reverse;animation-duration:28s}.core{position:absolute;left:50%;top:48%;transform:translate(-50%,-50%);width:120px;height:120px;border-radius:50%;display:grid;place-items:center;z-index:4;background:radial-gradient(circle,#20262b,#12161a 70%);border:1px solid rgba(255,255,255,.1);box-shadow:0 0 80px rgba(199,173,130,.08);animation:breathe 5s ease-in-out infinite}.core strong{font-size:1.9rem;font-weight:500;letter-spacing:-.05em}.core small{display:block;text-align:center;font-size:.52rem;text-transform:uppercase;letter-spacing:.13em;color:#7f888e;margin-top:-14px}
.node{position:absolute;z-index:5;width:185px;border:1px solid rgba(255,255,255,.1);border-radius:18px;padding:.9rem;background:rgba(16,19,22,.75);backdrop-filter:blur(16px);box-shadow:0 18px 55px rgba(0,0,0,.24);transition:.3s}.node:hover{transform:translateY(-5px);border-color:rgba(199,173,130,.18)}.n1{top:3rem;right:2.2rem}.n2{bottom:3.2rem;right:2.8rem}.n3{left:2rem;bottom:3rem}.node .k{font-size:.56rem;text-transform:uppercase;letter-spacing:.13em;color:#7b848a}.node .v{font-size:1.02rem;font-weight:550;margin-top:.3rem}.node .s{font-size:.68rem;color:#959da2;margin-top:.25rem;line-height:1.45}.wave{display:flex;align-items:center;gap:3px;height:34px;margin-top:.45rem}.wave i{width:3px;border-radius:10px;background:linear-gradient(180deg,var(--champ2),var(--sage));animation:wave 1.7s infinite}.wave i:nth-child(2n){animation-delay:.13s}.wave i:nth-child(3n){animation-delay:.27s}.path{position:absolute;inset:0;z-index:1}.path svg{width:100%;height:100%}.path path{fill:none;stroke:rgba(199,173,130,.2);stroke-width:1;stroke-dasharray:7 10;animation:dash 8s linear infinite}
...
.section{margin:1.5rem 0 .8rem}.section .num{font-size:.6rem;text-transform:uppercase;letter-spacing:.15em;color:#6f787e}.section h3{font-size:1.15rem;font-weight:500;letter-spacing:-.025em;margin:.2rem 0 0}.section p{font-size:.76rem;color:#7f888d;margin:.25rem 0 0}
.kpi{border:1px solid var(--line);border-radius:20px;padding:1.15rem 1.2rem;min-height:142px;background:linear-gradient(180deg,rgba(25,29,33,.9),rgba(18,21,24,.9));transition:.28s;position:relative;overflow:hidden}.kpi:hover{transform:translateY(-5px);border-color:rgba(199,173,130,.17);box-shadow:0 18px 48px rgba(0,0,0,.22)}.kpi .l{font-size:.61rem;text-transform:uppercase;letter-spacing:.13em;color:#788187}.kpi .v{font-size:2rem;font-weight:500;letter-spacing:-.05em;margin:.42rem 0 .15rem}.kpi .n{font-size:.73rem;color:#899196}.meter{height:2px;background:rgba(255,255,255,.045);margin-top:.9rem;border-radius:99px;overflow:hidden}.meter span{display:block;height:100%;background:linear-gradient(90deg,var(--champ),var(--sage))}
.panel{border:1px solid var(--line);border-radius:22px;background:rgba(19,23,27,.78);padding:1.25rem}.pt{font-size:1rem;font-weight:550}.ps{font-size:.74rem;color:#7f888e;margin:.25rem 0 1rem}.moment{display:grid;grid-template-columns:58px 1fr;gap:.8rem;padding:.82rem .1rem;border-bottom:1px solid rgba(255,255,255,.05);transition:.2s}.moment:last-child{border-bottom:0}.moment:hover{padding-left:.45rem;background:linear-gradient(90deg,rgba(199,173,130,.025),transparent)}.time{font-size:.64rem;color:#c8b28f}.mh{font-size:.8rem;font-weight:500}.tag{font-size:.55rem;text-transform:uppercase;letter-spacing:.07em;color:#b9a27d;border:1px solid rgba(199,173,130,.14);padding:.16rem .34rem;border-radius:999px;margin-left:.3rem}.mt{font-size:.75rem;color:#959da2;line-height:1.55;margin-top:.22rem}.decision{padding:.85rem .9rem;border:1px solid rgba(255,255,255,.055);border-radius:15px;background:rgba(255,255,255,.012);margin:.65rem 0;transition:.2s}.decision:hover{transform:translateX(4px);border-color:rgba(199,173,130,.14)}.conf{font-size:.57rem;color:#b7c5bf;border:1px solid rgba(146,169,159,.14);padding:.18rem .38rem;border-radius:999px;display:inline-flex;margin-top:.4rem}
.memory{border:1px solid var(--line);border-radius:22px;background:linear-gradient(180deg,rgba(23,27,31,.9),rgba(15,18,21,.94));padding:1.2rem}.q{font-family:'Instrument Serif';font-size:1.35rem;color:#ded6ca;line-height:1.25}.answer{font-size:.76rem;color:#9ba3a8;line-height:1.6;margin-top:.7rem}.source{margin-top:.9rem;font-size:.62rem;text-transform:uppercase;letter-spacing:.11em;color:#b7a17e}.footer{text-align:center;color:#555d63;font-size:.62rem;margin-top:3rem;padding-top:1.2rem;border-top:1px solid rgba(255,255,255,.045)}
@media(max-width:1050px){.hero{grid-template-columns:1fr}.canvas{min-height:520px}.copy{padding:3.4rem 1.8rem}.hero h1{font-size:clamp(2.9rem,10vw,5rem)}}@media(max-width:700px){.node.n2{display:none}.node{width:160px}.canvas{min-height:470px}.orbit{width:250px;height:250px}}
</style>
"""
...
with tabs[0]:
    ...
    st.markdown(f"""
    <div class="hero"><div class="copy"><div class="eyebrow">Decision intelligence</div><h1>Meetings become <span class="serif">memory.</span></h1><p>{meeting.get("summary","Turn conversation into durable decisions, clear ownership, and searchable memory.")}</p><div class="chips"><span class="chip">{meeting.get("title","Meeting")}</span><span class="chip">{meeting.get("duration_min",0)} minutes</span><span class="chip">{len(meeting.get("participants",[]))} participants</span></div><div class="promise">conversation → consequence <span></span></div></div>
      <div class="canvas"><div class="path"><svg viewBox="0 0 800 610" preserveAspectRatio="none"><path d="M130 490 C250 370,250 170,400 290 S620 220,700 100"/><path d="M105 115 C250 200,310 420,420 300 S610 400,700 490"/></svg></div><div class="orbit"></div><div class="core"><div><strong>{h["overall"]}</strong><small>clarity</small></div></div><div class="node n1"><div class="k">Decision signal</div><div class="v">{len(meeting.get("decisions",[]))} commitments</div><div class="s">What the team actually agreed to.</div></div><div class="node n2"><div class="k">Open attention</div><div class="v">{len(meeting.get("risks",[]))} unresolved</div><div class="s">Work that still needs a decision.</div></div><div class="node n3"><div class="k">Live conversation</div><div class="v">Signal detected</div><div class="wave">{bars}</div></div></div></div>""",unsafe_allow_html=True)
