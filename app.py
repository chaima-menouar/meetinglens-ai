...
.copy{padding:4.5rem 3.5rem 3.7rem;display:flex;flex-direction:column;justify-content:center;position:relative;z-index:3}.eyebrow{width:max-content;font-family:'DM Mono';font-size:.62rem;text-transform:uppercase;letter-spacing:.16em;color:#bba784;border:1px solid rgba(199,173,130,.17);border-radius:999px;padding:.45rem .65rem;background:rgba(199,173,130,.035);margin-bottom:1.35rem}
.hero h1{font-family:Sora,system-ui,sans-serif;font-weight:500;font-size:clamp(2.9rem,4.8vw,5.25rem);line-height:1.01;letter-spacing:-.055em;margin:0;max-width:700px}.hero h1 .accent{font-weight:600;color:var(--champ2);position:relative}.hero h1 .accent:after{content:'';position:absolute;left:0;bottom:-10px;width:72%;height:1px;background:linear-gradient(90deg,var(--champ2),transparent)}.hero p{max-width:600px;color:#a7afb4;font-size:1rem;line-height:1.78;margin:1.45rem 0 0}.chips{display:flex;gap:.55rem;flex-wrap:wrap;margin-top:1.4rem}.chip{font-size:.71rem;color:#c2c8cb;border:1px solid var(--line);border-radius:999px;padding:.44rem .65rem;background:rgba(255,255,255,.014)}.promise{display:flex;align-items:center;gap:.75rem;margin-top:1.7rem;font-family:'DM Mono';font-size:.63rem;letter-spacing:.13em;text-transform:uppercase;color:#747d82}.promise span{height:1px;flex:1;max-width:260px;background:linear-gradient(90deg,var(--champ),var(--sage),transparent);background-size:200% 100%;animation:flow 5s linear infinite}
.canvas{position:relative;min-height:610px;overflow:hidden;background-image:linear-gradient(180deg,rgba(11,14,17,.78),rgba(9,12,15,.9)),linear-gradient(90deg,rgba(10,13,16,.72),rgba(10,13,16,.2)),url('''+HERO_IMAGE+r''');background-size:118% auto;background-position:center;animation:imageBreath 18s ease-in-out infinite alternate}.canvas:before{content:'';position:absolute;inset:0;background:radial-gradient(circle at 58% 48%,rgba(199,173,130,.12),transparent 22%),radial-gradient(circle at 52% 45%,rgba(146,169,159,.06),transparent 36%);z-index:0}.canvas:after{content:'';position:absolute;inset:0;background-image:linear-gradient(rgba(255,255,255,.025) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.025) 1px,transparent 1px);background-size:42px 42px;mask-image:linear-gradient(to bottom,rgba(0,0,0,.8),transparent);z-index:1}
.orbit{position:absolute;left:50%;top:48%;transform:translate(-50%,-50%);width:320px;height:320px;border-radius:50%;border:1px solid rgba(255,255,255,.1);z-index:2}.orbit:before,.orbit:after{content:'';position:absolute;border-radius:50%;inset:25px;border:1px dashed rgba(199,173,130,.28);animation:ring 20s linear infinite}.orbit:after{inset:70px;border-style:solid;border-color:rgba(146,169,159,.17);animation-direction:reverse;animation-duration:28s}.core{position:absolute;left:50%;top:48%;transform:translate(-50%,-50%);width:120px;height:120px;border-radius:50%;display:grid;place-items:center;z-index:4;background:rgba(14,18,22,.84);backdrop-filter:blur(14px);border:1px solid rgba(255,255,255,.12);box-shadow:0 0 80px rgba(199,173,130,.1);animation:breathe 5s ease-in-out infinite}.core strong{font-family:Sora;font-size:1.9rem;font-weight:500;letter-spacing:-.05em}.core small{display:block;text-align:center;font-family:'DM Mono';font-size:.52rem;text-transform:uppercase;letter-spacing:.13em;color:#7f888e;margin-top:-14px}
.node{position:absolute;z-index:5;width:185px;border:1px solid rgba(255,255,255,.11);border-radius:18px;padding:.9rem;background:rgba(13,17,20,.79);backdrop-filter:blur(18px);box-shadow:0 18px 55px rgba(0,0,0,.28);transition:.3s}.node:hover{transform:translateY(-5px);border-color:rgba(199,173,130,.22)}.n1{top:3rem;right:2.2rem}.n2{bottom:3.2rem;right:2.8rem}.n3{left:2rem;bottom:3rem}.node .k{font-family:'DM Mono';font-size:.56rem;text-transform:uppercase;letter-spacing:.13em;color:#858e94}.node .v{font-family:Sora;font-size:1rem;font-weight:500;margin-top:.3rem}.node .s{font-size:.68rem;color:#a1a8ad;margin-top:.25rem;line-height:1.45}.wave{display:flex;align-items:center;gap:3px;height:34px;margin-top:.45rem}.wave i{width:3px;border-radius:10px;background:linear-gradient(180deg,var(--champ2),var(--sage));animation:wave 1.7s infinite}.wave i:nth-child(2n){animation-delay:.13s}.wave i:nth-child(3n){animation-delay:.27s}.path{position:absolute;inset:0;z-index:1}.path svg{width:100%;height:100%}.path path{fill:none;stroke:rgba(199,173,130,.24);stroke-width:1;stroke-dasharray:7 10;animation:dash 8s linear infinite}
.ticker{margin:1rem 0 1.3rem;overflow:hidden;border-top:1px solid var(--line);border-bottom:1px solid var(--line)}.track{display:flex;width:max-content;gap:2rem;padding:.68rem 0;animation:ticker 30s linear infinite}.titem{font-size:.66rem;color:#7f888d;white-space:nowrap}.titem b{color:#c8b28f;font-weight:500}.section{margin:1.5rem 0 .8rem}.section .num{font-family:'DM Mono';font-size:.6rem;text-transform:uppercase;letter-spacing:.15em;color:#6f787e}.section h3{font-family:Sora;font-size:1.12rem;font-weight:500;letter-spacing:-.025em;margin:.2rem 0 0}.section p{font-size:.76rem;color:#7f888d;margin:.25rem 0 0}.kpi{border:1px solid var(--line);border-radius:20px;padding:1.15rem 1.2rem;min-height:142px;background:linear-gradient(180deg,rgba(25,29,33,.9),rgba(18,21,24,.9));transition:.28s;position:relative;overflow:hidden}.kpi:hover{transform:translateY(-5px);border-color:rgba(199,173,130,.17);box-shadow:0 18px 48px rgba(0,0,0,.22)}.kpi .l{font-family:'DM Mono';font-size:.61rem;text-transform:uppercase;letter-spacing:.13em;color:#788187}.kpi .v{font-family:Sora;font-size:2rem;font-weight:500;letter-spacing:-.05em;margin:.42rem 0 .15rem}.kpi .n{font-size:.73rem;color:#899196}.meter{height:2px;background:rgba(255,255,255,.045);margin-top:.9rem;border-radius:99px;overflow:hidden}.meter span{display:block;height:100%;background:linear-gradient(90deg,var(--champ),var(--sage))}.panel{border:1px solid var(--line);border-radius:22px;background:rgba(19,23,27,.78);padding:1.25rem}.pt{font-family:Sora;font-size:.98rem;font-weight:500}.ps{font-size:.74rem;color:#7f888e;margin:.25rem 0 1rem}.moment{display:grid;grid-template-columns:58px 1fr;gap:.8rem;padding:.82rem .1rem;border-bottom:1px solid rgba(255,255,255,.05);transition:.2s}.moment:last-child{border-bottom:0}.moment:hover{padding-left:.45rem;background:linear-gradient(90deg,rgba(199,173,130,.025),transparent)}.time{font-family:'DM Mono';font-size:.64rem;color:#c8b28f}.mh{font-size:.8rem;font-weight:500}.tag{font-family:'DM Mono';font-size:.55rem;text-transform:uppercase;letter-spacing:.07em;color:#b9a27d;border:1px solid rgba(199,173,130,.14);padding:.16rem .34rem;border-radius:999px;margin-left:.3rem}.mt{font-size:.75rem;color:#959da2;line-height:1.55;margin-top:.22rem}.decision{padding:.85rem .9rem;border:1px solid rgba(255,255,255,.055);border-radius:15px;background:rgba(255,255,255,.012);margin:.65rem 0;transition:.2s}.decision:hover{transform:translateX(4px);border-color:rgba(199,173,130,.14)}.conf{font-family:'DM Mono';font-size:.57rem;color:#b7c5bf;border:1px solid rgba(146,169,159,.14);padding:.18rem .38rem;border-radius:999px;display:inline-flex;margin-top:.4rem}.memory{border:1px solid var(--line);border-radius:22px;background:linear-gradient(180deg,rgba(23,27,31,.9),rgba(15,18,21,.94));padding:1.2rem}.q{font-family:Sora;font-size:1.12rem;font-weight:500;color:#ded6ca;line-height:1.35}.answer{font-size:.76rem;color:#9ba3a8;line-height:1.6;margin-top:.7rem}.source{margin-top:.9rem;font-family:'DM Mono';font-size:.62rem;text-transform:uppercase;letter-spacing:.11em;color:#b7a17e}.footer{text-align:center;color:#555d63;font-family:'DM Mono';font-size:.62rem;margin-top:3rem;padding-top:1.2rem;border-top:1px solid rgba(255,255,255,.045)}
@media(max-width:1050px){.hero{grid-template-columns:1fr}.canvas{min-height:520px;background-size:cover}.copy{padding:3.4rem 1.8rem}.hero h1{font-size:clamp(2.7rem,9vw,4.7rem)}}@media(max-width:700px){.node.n2{display:none}.node{width:160px}.canvas{min-height:470px}.orbit{width:250px;height:250px}}
</style>
"""
...
with tabs[0]:
    ...
    st.markdown(f"""
    <div class="hero"><div class="copy"><div class="eyebrow">Decision intelligence</div><h1>From conversation to <span class="accent">decisions that move.</span></h1><p>{meeting.get("summary","Turn conversation into durable decisions, clear ownership, and searchable memory.")}</p><div class="chips"><span class="chip">{meeting.get("title","Meeting")}</span><span class="chip">{meeting.get("duration_min",0)} minutes</span><span class="chip">{len(meeting.get("participants",[]))} participants</span></div><div class="promise">conversation → consequence <span></span></div></div>
